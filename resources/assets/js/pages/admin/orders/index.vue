<template>
    <div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-4">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" v-model="tableData.search" @input="getData()" />
                        </div>
                    </div>
                    <div class="form-group col-4">
                ...
                <datatable :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
                    <tbody>
                        <tr v-for="item in data" :key="item.serial">
                            ...
                            <td v-if="item.received_date == null">
                                <span type="button" @click="serve(item.id, 'serve')"
                                    v-if="item.delivery_date == null"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
                                        <path
                                            d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                    </svg></span>
                                <span type="button" class="text-danger" @click="serve(item.id, 'update')"
                                    v-if="item.delivery_date != null"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <span type="button" @click="edit(item.id)" data-toggle="modal"
                                    data-target="#editOrderModal"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                <span type="button" class="text-danger" @click="del(item.id)"><svg
                            ...
                            <td v-else>
                                <span type="button" class="text-danger" @click="serve(item.id, 'update')"
                                    :disabled="item.received_date != null"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <select v-model="tableData.length" @change="getData()" class="form-control col-lg-1">
        ...
        <receive :user="user" @refresh="getData()" :data="details" @notify="refreshNotification()"
            @closeModal="serveModal = false" v-if="serveModal"></receive>

        <update :user="user" @refresh="getData()" :data="details" @closeModal="updateModal = false" v-if="updateModal">
        </update>

        <edit :id="id" :data="editData" :user="user" @refresh="getData()" v-if="editModal"
            @closeModal="editModal = false"></edit>
    </div>
</template>
