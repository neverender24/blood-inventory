                        ...
                        <form class="forms-sample">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control" v-model="data.blood_station_id">
                                    <option v-for="option in bloodStations" v-bind:item="option" :value="option.id">{{
                                        option.name }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control form-control" v-model="data.position">
                                    <option v-for="option in positions" v-bind:item="option" :value="option">{{ option
                                        }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control form-control" v-model="data.role">
                                    <option v-for="option in roles" v-bind:item="option" :value="option">{{ option }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
